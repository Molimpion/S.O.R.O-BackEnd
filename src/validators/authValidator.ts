...
// Schema para o registo (agora espera os campos públicos corretos)
...
// Schema para o login (agora espera 'password')
export const loginSchema = z.object({
  email: z.string().email(),
  password: z.string({ required_error: 'A senha é obrigatória' }),
});

// Schema para atualização de utilizador (também usa os nomes públicos)
