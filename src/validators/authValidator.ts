...
export const registerSchema = z.object({
  body: z.object({ 
    ...
    id_unidade_operacional_fk: z.string().uuid().nullable().optional(), // Pode ser nulo
  })
});
...
export const putUserSchema = z.object({
  body: z.object({ 
    ...
    id_unidade_operacional_fk: z.string().uuid("ID de unidade inválido").nullable(), // Permite desassociar (null)
...
export const patchUserSchema = z.object({
  body: z.object({ 
    ...
    id_unidade_operacional_fk: z.string().uuid("ID de unidade inválido").nullable().optional(),
